...
sentinel_cfg = SuppoConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_suppod_proto_version_with_sentinel_ping = 70207


def get_suppo_conf():
    home = os.environ.get('HOME')

    suppo_conf = os.path.join(home, ".suppocore/suppo.conf")
    if sys.platform == 'darwin':
        suppo_conf = os.path.join(home, "Library/Application Support/suppocore/suppo.conf")

    suppo_conf = sentinel_cfg.get('suppo_conf', suppo_conf)
