...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to suppod "gobject list" output
    ...
    def suppod_serialise(self):
        import suppolib
        return suppolib.SHIM_serialise_for_suppod(self.serialise())
